...
export class MapCodeEditorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var highlighter = joint.V('circle', {
        'r': 10,
        'stroke': '#000000',
        'stroke-width': '2px',
        'fill': 'transparent',
    ...
    paper.off('cell:highlight cell:unhighlight').on({
        ...
        'cell:highlight': function(cellView, el, opt) {
            ...
            if (opt.embedding) {
                joint.V(el).addClass('highlighted-parent');
            }
    
            if (opt.connecting) {
                var bbox = joint.V(el).bbox(false, paper.viewport);
        ...
        'cell:unhighlight': function(cellView, el, opt) {
            ...
            if (opt.embedding) {
                joint.V(el).removeClass('highlighted-parent');
            }
